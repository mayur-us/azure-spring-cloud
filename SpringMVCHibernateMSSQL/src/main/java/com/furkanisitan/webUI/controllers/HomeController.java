...
//    @RequestMapping(value = {"home/index"})
    ...
    @RequestMapping(value = "home/find", params = {"email"})
    public String find(@RequestParam(value = "email") String email, Model model) {
        model.addAttribute("customer", _customerService.getByEmail(email));
        return "home/createorupdate";
    }
